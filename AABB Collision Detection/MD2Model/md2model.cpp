...
void CMD2Model::Collided(ObjectType collidedObject)
{
	if(collidedObject == ObjectType::Model3D)
	{
	printf("I'm CMD2Model and I've collided with Model3D. \n");
    
	}
	else
	{
		printf("I've collided with something! \n");
	}
}
CMD2Model::CMD2Model()
{
